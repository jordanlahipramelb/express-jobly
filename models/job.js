...
class Job {
   ...
   *
   * Returns [{ id, title, salary, equity, companyHandle, companyName }, ...] where company is { handle, name, description, numEmployees, logoUrl}
   *
  ...
  static async get(id) {
    ...
    delete job.companyHandle; //delete this column
